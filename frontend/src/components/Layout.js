                ...
                {user ? (
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    {config.allowUserRegistration && (
                      <Link to="/register" className="text-gray-500 hover:text-gray-900 text-sm font-medium">
                        Register
                      </Link>
                    )}
                  </div>
          ...
          <div className="pt-2 pb-3 space-y-1">
            ...
            {user ? (
              <div className="border-t border-gray-200 pt-4">
                ...
                <button
                  onClick={handleLogout}
                  className="flex items-center gap-2 w-full px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-100 transition-colors"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z" clipRule="evenodd" />
                  </svg>
